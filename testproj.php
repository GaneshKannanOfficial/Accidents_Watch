...
if (isset( $_POST['snoEdit'])){
  ...
  $sql = "UPDATE `notes` SET `acc` = '$acc' , `year` = '$year' , `fine` = '$fine' WHERE `notes`.`sno` = $sno";
  $result = mysqli_query($conn, $sql);
  if($result){
    $update = true;
}
  ...
  // Sql query to be executed
  $sql = "INSERT INTO `notes` (`acc`, `year`,`fine`) VALUES ('$acc', '$year','$fine')";
  $result = mysqli_query($conn, $sql);
...
<body>
  ...
  <div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="editModalLabel"
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <form action="/ganesh/testproj.php" method="POST">
          <div class="modal-body">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="fineEdit" name="fine" aria-describedby="emailHelp">
            </div> 
          </div>
  ...
  <div class="container my-4">
    <h2>WANNA MANAGE THE ACCIDENT REPORT?</h2>
    <form action="/ganesh/testproj.php" method="POST">
      <div class="form-group">
        <label for="title"> Accident Type </label>
    ...
    Array.from(deletes).forEach((element) => {
      element.addEventListener("click", (e) => {
        ...
        if (confirm("Are you sure you want to delete this note!")) {
          console.log("yes");
          window.location = `/ganesh/testproj.php?delete=${sno}`;
