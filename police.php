...
<div class="container my-4" style="box-shadow:5px 10px 18px black;border-radius:30px">
    <h2 style="text-align:center">POLICE DEPARTMENT</h2>
    <form action="/dbmsProject/police.php" method="POST">
        ...
        <button class="btn btn-primary" onclick="window.open('history_police.php','_blank')" >HISTORY</button><br><br>
    </form>
</div>
</div>
